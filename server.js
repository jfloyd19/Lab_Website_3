...
var choice = url_info.query
var id_choice = choice.player_choice;
console.log(id_choice);
var query1 = 'SELECT id, name FROM football_players;';
var query2 = 'select * from football_players where id='+id_choice+';';
var query3 = 'select count(*) from football_games where '+id_choice+' = any(players)';
db.task('get-everything', task => {
    return task.batch([
        task.any(query1),
        task.any(query2),
